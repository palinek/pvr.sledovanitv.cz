...
[![Build status](https://travis-ci.org/palinek/pvr.sledovanitv.cz.svg?branch=Matrix)](https://travis-ci.org/palinek/pvr.sledovanitv.cz)
[![Build status](https://ci.appveyor.com/api/projects/status/02qaoie8tcv4klnf/branch/Matrix?svg=true)](https://ci.appveyor.com/project/palinek/pvr-sledovanitv-cz/branch/Matrix)
...
1. `git clone --branch Matrix --depth=1 https://github.com/xbmc/xbmc.git`
2. `git clone --branch Matrix --depth=1 https://github.com/palinek/pvr.sledovanitv.cz.git`
